<%@ Page Title="" Language="C#" MasterPageFile="~/views/MasterPages/MainMaster.Master" AutoEventWireup="true" CodeBehind="QualifiedCandidateDetails.aspx.cs" Inherits="Devasthanam.views.Admin.QualifiedCandidateDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../../StyleSheets/QualifiedCandidateDetails.css" rel="stylesheet" />
    <script src="../../Scripts/Js_Page/QualifiedCandidateDetails.js"></script>
</asp:Content>
        ...
        <asp:GridView runat="server" ID="gv_Download" AutoGenerateColumns="False">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Qualified">
                    <ItemTemplate>
                        <asp:Label ID="lblQualified" runat="server" Text='<%# Bind("Qualified") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
